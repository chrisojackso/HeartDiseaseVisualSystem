class Barchart {
    ...
    constructor(_config, _dispatcher, _data) {
        ...
        this.config = {
            ...
            margin: _config.margin || {top: 25, right: 20, bottom: 20, left: 90},
        }
    ...
    initVis() {
        ...
        vis.colorScale = d3.scaleOrdinal()
            .range(d3.schemeCategory10 ) // Different color for each region
        ...
        vis.xAxis = d3.axisBottom(vis.xScale)
            .ticks(data.map(function(d) { return d.AgeCategory;}))
            .tickSizeOuter(0);
    ...
    updateVis() {
        ...
        // Prepare data: count number of countries in each region
        // i.e. [{ key: 'easy', count: 10 }, {key: 'intermediate', ...
        const aggregatedDataMap = d3.rollups(vis.data, v => v.length, d => d.AgeCategory);
        vis.aggregatedData = Array.from(aggregatedDataMap, ([key, count]) => ({ key, count }));

        const orderedKeys = ['80 or older', '75-79', '70-74', '65-69', '60-64', '55-59', '50-54', '45-49', '40-44', '35-39', '30-34', '25-29', '18-24'];
